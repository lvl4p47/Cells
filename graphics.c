...
void Graphics_Init()
{
    ...
    window = SDL_CreateWindow("templateSDL", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, WINDOW_WIDTH, WINDOW_HEIGHT, SDL_WINDOW_SHOWN);
    if (window == NULL) {
            ...
            for(int j = min_x; j <= max_x; j++)
            {
                ...
                if(id == id1)
                {
                    ...
                    else
                    {
                        ...
                        r = 0;
                        g = (255 - value) * life_wave_str / 255;
                        b = value * life_wave_str / 255;
                        // r = life_wave_str;
                        // g = life_wave_str;
                        // b = life_wave_str;
                    }
